template _tmp_830
{
    ...
    pageheader _tmp_937
    {
        ...
        valuefield _tmp_113
        {
            ...
            location = (66.138916015625, 39.55);
        ...
        {
            name = "Символ_1";
            file = "fVF(\"IS_01_MSK_Signatures.txt\",GetValue(\"USERDEFINED.ru_8_fam\") , 2)";
            symbolid = 0;
            refpoint = (47.6, 22.4);
            height = 10;
            width = 10;
